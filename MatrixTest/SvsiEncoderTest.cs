...
public class SvsiEncoderTest
{
    ...
    private readonly Mock<SyncInfoHandler> _mockInputStatusChangedHandler;

    public SvsiEncoderTest()
    {
        _mockClient = new("foo", SvsiBase.DefaultPort, "bar");
        _svsiEncoder = new("Test", _mockClient.Object);
    ...
    public void ResponseHandler_ProcessesStatusData()
    {
        ...
        _mockInputStatusChangedHandler.Verify(x => x.Invoke(ConnectionStatus.Disconnected, "0x0"));
    }
    ...
    public void ResponseHandler_HandlesInput()
    {
        ...
        _mockInputStatusChangedHandler.Verify(x => x.Invoke(ConnectionStatus.Connected, "1920x1080"));
    }
