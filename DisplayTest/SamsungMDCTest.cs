...
public class SamsungMDCTest
{
    ...
    public void SendByteArray_DoesNotManipulateInput()
    {
        ...
        method?.Invoke(_samsungMdc, [input]);
    ...
    public void GenerateChecksum_AddsAllValues()
    {
        ...
        byte result = (byte)(method?.Invoke(_samsungMdc, [input]) ?? 0x00);
    ...
    {
        _samsungMdc.HandleResponse([0xAA, 0xFF, 0x00, 0x03, (byte)'A', 0x11, 0x00, 0xFF]);
        _samsungMdc.HandleResponse([0xAA, 0xFF, 0x00, 0x03, (byte)'A', 0x11, 0x01, 0xFF]);
        _samsungMdc.HandleResponse([0xAA, 0xFF, 0x00, 0x03, (byte)'A', 0x11, 0x02, 0xFF]);
