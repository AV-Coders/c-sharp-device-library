...
public class DyNetTest
{
    ...
    [Theory]
    [InlineData(27, 0, 0, new byte[] { 0x1C ,0x1B ,0x64 ,0x00 ,0x00 ,0x00 ,0xFF ,0x66 })]
    [InlineData(27, 1, 0, new byte [] {0x1C ,0x1B ,0x64 ,0x01 ,0x00 ,0x00 ,0xFF ,0x65 })]
    [InlineData(27, 2, 0, new byte [] {0x1C ,0x1B ,0x64 ,0x02 ,0x00 ,0x00 ,0xFF ,0x64 })]
    [InlineData(27, 10, 0, new byte [] {0x1C ,0x1B ,0x64 ,0x0A ,0x00 ,0x00 ,0xFF ,0x5C })]
