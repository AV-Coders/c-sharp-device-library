...
Published to [nuget.org](https://www.nuget.org/packages/AVCoders.Core). See the [repository README](https://github.com/AV-Coders/c-sharp-device-library) for details.
